...
class SearchFactory {
  ...
  createTokenizer(...args) {
    return this.registry.createInstance('tokenizer', SearchTokenizer, ...args)
  }
   ...
   */
  createParser(...args) {
    return this.registry.createInstance('parser', SearchParser, ...args)
  }
  ...
  createInterpreter(...args) {
    return this.registry.createInstance('interpreter', SearchInterpreter, ...args)
  }
}
